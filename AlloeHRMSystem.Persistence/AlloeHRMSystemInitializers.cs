...
namespace AlloeHRMSystem.Persistence
{
    public class AlloeHRMSystemInitializers
    {
             ...
             int? retry = 0)
        {
            ...
            catch (Exception ex)
            {
                if (retryForAvailability < 10)
                {
                    ...
                    //var log = loggerFactory.CreateLogger<AlloeHRMSystemInitializers>();
        ...
        public static void SeedAppUsers(UserManager<AppUser> userManager)
        {
        ...
        public static void SeedEmployAttachment(AlloeContext context)
        {
            var employatt = new[] {
        ...
        public static void SeedEmployCertificates(AlloeContext context)
        {
            var employcert = new[] {
        ...
        public static void SeedEmployEducations(AlloeContext context)
        {
            var employed = new[] {
        ...
        public static void SeedEmployEmergencyCall(AlloeContext context)
        {
            var employemer = new[] {
        ...
        public static void SeedEmploLanguages(AlloeContext context)
        {
            var employlan = new[] {
        ...
        public static void SeedEmployProjects(AlloeContext context)
        {
            var employpro = new[] {
        ...
        public static void SeedEmployQuits(AlloeContext context)
        {
            var employqu = new[] {
        ...
        public static void SeedEmployTechSkills(AlloeContext context)
        {
            var employtec = new[] {
        ...
        public static void SeedEmployTrainings(AlloeContext context)
        {
            var employtrai = new[] {
