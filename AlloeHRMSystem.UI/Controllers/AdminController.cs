...
using AlloeHRMSystem.UI.ViewModels.AdminViewModel;
...
namespace AlloeHRMSystem.UI.Controllers
{
    public class AdminController : Controller
    {
        ...
        public AdminController(RoleManager<AppRole> roleManager,
          UserManager<AppUser> userManager, ILogger<AdminController> logger)
        {
        ...
        public async Task<IActionResult> ManageUserClaims(string userId)
        {
            ...
            foreach (Claim claim in ClaimsStore.AllClaims)
            {
                ...
                // if the user has the cliam, set IsSelected property to true, so the checkbox
                // next tot the cliam is checked on the UI
       ...
       // [Authorize(Policy = "DeleteRolePolicy")]
        public async Task<IActionResult> DeleteRole(string id)
        {
            ...
            else
            {
                ...
                catch (DbUpdateException ex)
                {
                    ...
                    ViewBag.ErrorMessage = $"{role.Name} role cannot be deleted as their users" +
        ...
        public async Task<IActionResult> EditUser(string id)
        {
            ...
            var model = new EditUserViewModel
            {
               // EmployeeId = user.EmployeeId,
                ...
                PasswordExpirationEnable = user.PasswordExpirationEnable,
                CanMakeCall = user.CanMakeCall,
        ...
        public async Task<IActionResult> EditUser(EditUserViewModel model)
        {
            ...
            else
            {
              //  user.EmployeeId = model.EmployeeId;
                ...
                user.LastPasswordUpdate = model.LastPasswordUpdate;
                user.PasswordExpirationEnable = model.PasswordExpirationEnable;
                user.CanMakeCall = model.CanMakeCall;
        ...
        public async Task<IActionResult> EditRole(EditRoleViewModel model)
        {
            ...
            if (role == null)
            {
                ViewBag.ErrorMessage($"Role with this Id = {model.Id} cannot be found");
                return View("NotFound");
            }
            else
            {
