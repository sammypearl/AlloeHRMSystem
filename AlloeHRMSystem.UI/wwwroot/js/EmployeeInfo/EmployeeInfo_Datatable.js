$(document).ready(function () {
    document.title = 'EmployeeInfo DataTable';
    $("#tblEmployeeInfo").DataTable({
        ...
        "ajax": {
            "url": "/EmployeeInfo/GetDataTabelData",
            "type": "POST",
            "datatype": "json"
        },
        ...
        "columns": [
            ...
            { "data": "MobileNo", "name": "MobileNo", "autoWidth": true },
            {
                data: null, render: function (data, type, row) {
                    ...
                    onclick = AddEditEmployeeInfo('" + row.ID + "');> Edit</a > ";
                }
            },
            {
                data: null, render: function (data, type, row) {
                    return "<a href='#' class='btn btn-danger btn-sm' 
                    onclick = DeleteEmployeeInfo('" + row.ID + "'); > Delete</a > ";
                }
            }
        ],
